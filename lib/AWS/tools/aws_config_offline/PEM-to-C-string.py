...
CREDS_MACRO_MAP = {
    CredentialType.CLIENT_CERT: 'democonfigCLIENT_CERTIFICATE_PEM',
    CredentialType.ROOT_CA_CERT: 'democonfigROOT_CA_PEM',
    CredentialType.PRIVATE_KEY: 'democonfigCLIENT_PRIVATE_KEY_PEM'
}

# Prints the passed credential file as a C string. If a specific type of the
# credential is passed, then its associated configuration macro from
